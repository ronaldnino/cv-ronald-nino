...
export const metadata: Metadata = {
  ...
  icons: {
    icon: [
      { url: '/cv-ronald-nino/favicon.ico',   sizes: '48x48',  type: 'image/x-icon' },
      { url: '/cv-ronald-nino/icon-192.png',  sizes: '192x192', type: 'image/png' },
      { url: '/cv-ronald-nino/icon-512.png',  sizes: '512x512', type: 'image/png' },
    ],
    apple: [
      { url: '/cv-ronald-nino/apple-touch-icon.png', sizes: '180x180', type: 'image/png' },
    ],
    shortcut: '/cv-ronald-nino/favicon.ico',
  },
  openGraph: {
    title: 'Ronald Niño · Cloud & DevOps Engineer',
